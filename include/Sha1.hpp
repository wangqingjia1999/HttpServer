 ...
 * Richard Walters (github username: rhymu8354) is my teacher (although he
 * doesn't know me). I've learnt a lot from him. Highly recommended to follow
 * him, if you like. I will take some time to figure out this amazing algorithm.
 */
#pragma once
...
namespace Sha1
{
	...
	/**
	 * Core function to convert given data into message digest in the form of
	 * bytes.
	 *
	 * @param[in] data
	 *      Data in the form of bytes sequence/vector.
